...
class Movies { 
    constructor(id, title, year, genre, cast, cover) {
        this.id = id;
        this.title = title;
        this.year = year;
        this.genre = genre;
...
let m1 = new Movies("ID002", "El príncipe de Zamunda", 1988, "comedia", "Eddie Murphy", "https://i.pinimg.com/736x/7c/cc/71/7ccc7128574285284d90f926fffcee91.jpg" );
